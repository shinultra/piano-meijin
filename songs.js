const SONG_LIST = [
  {
    ...
    notes: [
      ...
      { key: '2', time: 9.0 }, { key: '2', time: 9.75 }, { key: '1', time: 10.5, duration: 1.5 }
    ]
  },
  {
    id: 'song2',
    ...
    notes: [
      ...
      { key: '3', time: 5.0, duration: 0.6 }, { key: '2', time: 6.0 }, { key: '2', time: 6.75 },
      { key: '2', time: 7.5, duration: 0.6 }, { key: '3', time: 8.25 }, { key: '5', time: 9.0 },
      { key: '5', time: 10.0 }, { key: '3', time: 11.0, duration: 1.4 }
    ]
  },
  {
    id: 'song3',
    ...
    notes: [
      ...
      { key: '6', time: 3.5 }, { key: '6', time: 4.25 }, { key: '5', time: 5.0, duration: 0.6 },
      { key: '4', time: 6.0 }, { key: '4', time: 6.75 }, { key: '3', time: 7.5 }, { key: '3', time: 8.25 },
      { key: '2', time: 9.0 }, { key: '2', time: 9.75 }, { key: '1', time: 10.5, duration: 0.7 }, { key: '1', time: 11.75 },
      { key: '2', time: 12.5 }, { key: '3', time: 13.25 }, { key: '1', time: 14.0, duration: 2.0 }
    ]
  },
  {
    id: 'song4',
    ...
    notes: [
      ...
      { key: '4', time: 7.25 }, { key: '5', time: 8.0, duration: 0.6 },  { key: '5', time: 8.75 },
      { key: '5', time: 9.5 },  { key: '5', time: 10.5 }, { key: '3', time: 11.25 },
      { key: '3', time: 12.0, duration: 1.4 }
    ]
  },
  {
    id: 'song5',
    ...
    notes: [
      ...
      { key: '3', time: 5.25 }, { key: '1', time: 6.0, duration: 0.6 },  { key: '3', time: 7.0 },
      { key: '4', time: 7.75 }, { key: '5', time: 8.5, duration: 0.8 },  { key: '3', time: 9.5 },
      { key: '4', time: 10.25 },{ key: '5', time: 11.0, duration: 0.8 }, { key: '5', time: 12.0 },
      { key: '6', time: 12.5 }, { key: '5', time: 13.0 }, { key: '4', time: 13.5 },
      { key: '3', time: 14.0 }, { key: '1', time: 14.75, duration: 1.6 }
    ]
  },
  {
    id: 'song6',
  ...
  },
  {
    ...
    notes: [
      ...
      { key: '3', time: 9.5, duration: 0.7 },   { key: '2', time: 10.5 },  { key: '2', time: 11.25, duration: 1.6 }
    ]
  },
  {
    id: 'song8',
    ...
    notes: [
      ...
      { key: '5', time: 3.5 },   { key: '3', time: 4.0, duration: 0.6 },
      { key: '4', time: 4.75 },  { key: '4', time: 5.25 },  { key: '3', time: 5.75 },
      { key: '2', time: 6.25 },  { key: '1', time: 6.75, duration: 0.6 },
      { key: '3', time: 7.5 },   { key: '5', time: 8.0 },   { key: '6', time: 8.5, duration: 0.6 },
      { key: '5', time: 9.0 },   { key: '4', time: 9.5 },   { key: '3', time: 10.0 },
      { key: '2', time: 10.5 },  { key: '1', time: 11.25, duration: 1.8 }
    ]
  },
  {
    id: 'song9',
    ...
    notes: [
      ...
      { key: '6', time: 4.75 },  { key: '5', time: 5.5, duration: 0.6 },
      { key: '6', time: 6.0 },   { key: '7', time: 6.5 },   { key: '8', time: 7.0, duration: 0.9 },
      { key: '5', time: 8.0 },   { key: '6', time: 8.5 },   { key: '7', time: 9.0 },
      { key: '8', time: 9.75, duration: 0.6 },  { key: '7', time: 10.5 },  { key: '5', time: 11.25 },
      { key: '3', time: 12.25 }, { key: '5', time: 12.75 }, { key: '1', time: 13.5, duration: 0.6 },
      { key: '8', time: 14.25, duration: 1.6 }
    ]
  }
];
